...
},{"../data/config":1,"../lib/exDefEasyui":4,"../lib/exDefJquery":5,"../lib/exy":6,"../lib/jquery":10,"../lib/jquery.autocompleteplus":7,"../lib/jquery.cookie":8,"../lib/jquery.easyui.min":9,"../lib/lambda":11}],3:[function(require,module,exports){
require('./base');
require('../lib/stp');
...
},{"../lib/stp":12,"./base":2}],4:[function(require,module,exports){
//基于easyui的扩展
module.exports={
    // 弹窗
...
module.exports={
        ...
        importing:function(){
            ...
            $script(ags[0]+(window.config.distVersion?'?version='+window.config.distVersion:''),function(){
                arguments.callee.apply(this,[].slice.call(ags,1));
            })
        }
    };
