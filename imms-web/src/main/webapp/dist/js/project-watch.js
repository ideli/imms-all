...
},{"../lib/exDefEasyui":3,"../lib/exDefJquery":4,"../lib/exy":5,"../lib/jquery":9,"../lib/jquery.autocompleteplus":6,"../lib/jquery.cookie":7,"../lib/jquery.easyui.min":8,"../lib/lambda":10}],2:[function(require,module,exports){
require('./base');
require('../lib/stp');
//
//var data=[
...
},{"../lib/stp":11,"./base":1}],3:[function(require,module,exports){
//基于easyui的扩展
module.exports={
    // 弹窗
...
module.exports={
        ...
        $script:function(src,cb){
            src.match(/^http|^\.|^\//)!=null || (src=top.path+'/scripts/'+src);
            src.match(/\.js$/i)!=null || (src+='.js');
            jQuery.getScript(src,cb);
            },
        //清除linkbutton点击后的虚线
        ...
        toast:function(str){
                ...
                var p=jQuery('<div><p><b></b>str</p></div>'.replace('str',str));
...
module.exports={
        ...
        //防止百分号标签空白输出在页面上
        getSecurityData:function(data){
                return data||null;
            },
        replaceDDD:function(value){return value.replace(/\<ddd\>/gm,"'");},
        //原生弹窗的封装
        open2:function(){
                var features='';
